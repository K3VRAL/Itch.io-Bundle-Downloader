...
def init():
    ...
    parser.add_argument("-f", "--folder", nargs = "+", help = "Changes the target download folder location instead of using the current directory")
    parser.add_argument("-r", "--reprocess", help = "Ignores all already downloaded files and their status", action = argparse.BooleanOptionalAction)        
